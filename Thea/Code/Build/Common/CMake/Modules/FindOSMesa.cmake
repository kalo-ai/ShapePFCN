...
IF(OSMesa_LIBRARY_DIRS)
  ...
  IF(PKG_CONFIG_FAILED)
    FIND_LIBRARY(OSMesa_LIBRARIES NAMES OSMesa osmesa32 PATHS ${OSMesa_LIBRARY_DIRS} PATH_SUFFIXES x86_64-linux-gnu NO_DEFAULT_PATH)
    FIND_LIBRARY(OSMesa_GL_LIBRARIES NAMES GL opengl opengl32 PATHS ${OSMesa_LIBRARY_DIRS} PATH_SUFFIXES x86_64-linux-gnu NO_DEFAULT_PATH)
    FIND_LIBRARY(OSMesa_GLU_LIBRARIES NAMES GLU glu32 PATHS ${OSMesa_LIBRARY_DIRS} PATH_SUFFIXES x86_64-linux-gnu NO_DEFAULT_PATH)
